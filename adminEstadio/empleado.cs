...
namespace adminEstadio
{
    public partial class empleado : Form
    {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            Font fuente = new Font("Cambria", 14, FontStyle.Bold);

            e.Graphics.DrawString("Nombre: " + nombre.Text.Trim() + "" + apellidoPat.Text.Trim(), fuente, Brushes.Black, new Point(50, 260));
            e.Graphics.DrawString("Categoria: " + categoria.Text, fuente, Brushes.Black, new Point(50, 460));
            ...
            e.Graphics.DrawString("*" + id.Text.Trim() + "*", fuente, Brushes.Black, new Point(150, 460));
